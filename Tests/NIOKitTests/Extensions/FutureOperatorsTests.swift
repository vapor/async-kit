...
final class FutureOperatorTests: XCTestCase {
    ...
    func testAddition() throws {
        var future1 = eventLoop.makeSucceededFuture(result: 8)
        let future2 = eventLoop.makeSucceededFuture(result: 5)
        ...
        var arrayFuture1 = eventLoop.makeSucceededFuture(result: [1, 2, 3])
        let arrayFuture2 = eventLoop.makeSucceededFuture(result: [4, 5, 6])
    ...
    func testSubtraction() throws {
        ...
        var arrayFuture1 = eventLoop.makeSucceededFuture(result: [1, 2, 3, 4, 5, 6])
        let arrayFuture2 = eventLoop.makeSucceededFuture(result: [4, 5, 6])
    ...
    func testDivision() throws {
        var future1 = eventLoop.makeSucceededFuture(result: 40)
        let future2 = eventLoop.makeSucceededFuture(result: 5)
    ...
    func testComparison() throws {
        let future1 = eventLoop.makeSucceededFuture(result: 8)
        let future2 = eventLoop.makeSucceededFuture(result: 5)
        let future3 = eventLoop.makeSucceededFuture(result: 5)
    ...
    func testBitshifts() throws {
        var future1 = eventLoop.makeSucceededFuture(result: 255)
        let future2 = eventLoop.makeSucceededFuture(result: 16)
        ...
        var future3 = eventLoop.makeSucceededFuture(result: 16711680)
        let future4 = eventLoop.makeSucceededFuture(result: 16)
    ...
    func testAND() throws {
        var future1 = eventLoop.makeSucceededFuture(result: 200)
        let future2 = eventLoop.makeSucceededFuture(result: 500)
    ...
    func testNOT() throws {
        let future1: EventLoopFuture<UInt8> = eventLoop.makeSucceededFuture(result: 0b00001111)
