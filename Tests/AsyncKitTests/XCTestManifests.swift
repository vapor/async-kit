...
extension EventLoopFutureQueueTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
...
extension FutureCollectionTests {
    ...
    static let __allTests__FutureCollectionTests = [
        ...
        ("testFlatMapEachCompactThrowing", testFlatMapEachCompactThrowing),
        ("testFlatMapEachThrowing", testFlatMapEachThrowing),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(EventLoopFutureQueueTests.__allTests__EventLoopFutureQueueTests),
